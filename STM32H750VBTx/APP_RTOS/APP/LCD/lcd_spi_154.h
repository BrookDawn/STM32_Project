...
#define  LCD_CS_PIN				GPIO_PIN_11			         // 片选  引脚
#define	LCD_CS_PORT				GPIOE							// 片选  GPIO端口
#define 	GPIO_LDC_CS_CLK_ENABLE     __HAL_RCC_GPIOE_CLK_ENABLE()	// 片选  GPIO时钟

#define	LCD_CS_Select		   HAL_GPIO_WritePin(LCD_CS_PORT, LCD_CS_PIN, GPIO_PIN_RESET);	   // 低电平，选中LCD
#define 	LCD_CS_Deselect		   HAL_GPIO_WritePin(LCD_CS_PORT, LCD_CS_PIN, GPIO_PIN_SET);		// 高电平，取消选中LCD
