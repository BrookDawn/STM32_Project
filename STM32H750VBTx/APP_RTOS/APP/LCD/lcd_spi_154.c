 /***
   ...
   *  @description
	*
	*	实验平台：反客STM32H750VBT6核心板 （型号：FK750M1-VBT6）+ 1.54寸液晶模块（型号：SPI154M1-240*240）
...
// Note: HAL_SPI_MspInit 和 MX_SPI4_Init 已在 Core/Src/spi.c 中定义
