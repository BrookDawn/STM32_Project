...
void MX_SPI4_Init(void)
{
  ...
  hspi4.Init.DataSize = SPI_DATASIZE_8BIT;  // 修正：LCD需要8位数据宽度
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  */
    ...
    */
    ...
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;  // 优化: 提升到最高速度
    ...
    /* DMA1_Stream1 interrupt Init - DMA传输完成中断 */
    HAL_NVIC_SetPriority(DMA1_Stream1_IRQn, 6, 0);
    HAL_NVIC_EnableIRQ(DMA1_Stream1_IRQn);

    /* SPI4 interrupt Init - 优先级必须高于FreeRTOS内核(configMAX_SYSCALL=5) */
